	...
	var factory = function (exports) {
		...
		exports.fn.tableDialog = function() {
			...
			var dialogContent = [
				...
				"<label style=\"padding: 0px 0 22px 5px;\">" + dialogLang.cellsLabel + "：</label>",
				dialogLang.rows + " <input type=\"number\" value=\"3\" class=\"number-input\" style=\"width:auto;padding: 4px 8px;\" max=\"100\" min=\"2\" data-rows />&nbsp;&nbsp;",
				dialogLang.cols + " <input type=\"number\" value=\"2\" class=\"number-input\" style=\"width:auto;padding: 4px 8px;\" max=\"100\" min=\"1\" data-cols /><br/>",
